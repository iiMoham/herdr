...
fn parse_pane_input_args(
    ...
    const USAGE: &str =
        "usage: momo pane input [<pane_id>|--pane ID|--current] --right-click herdr|pane";
...
fn parse_pane_split_args(
    ...
    let Some(direction) = direction else {
        return Err(
            "usage: momo pane split [<pane_id>|--pane ID|--current] --direction right|down [--ratio FLOAT] [--cwd PATH] [--env KEY=VALUE] [--right-click herdr|pane] [--focus] [--no-focus]"
                .into(),
        );
    };
...
fn print_pane_help() {
    ...
    eprintln!("  momo pane input [<pane_id>|--pane ID|--current] --right-click herdr|pane");
    eprintln!(
        "  momo pane split [<pane_id>|--pane ID|--current] --direction right|down [--ratio FLOAT] [--cwd PATH] [--env KEY=VALUE] [--right-click herdr|pane] [--focus] [--no-focus]"
    );
